...
//        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a.btn.btn-primary[href='https://prod-kurs.coderslab.pl/index.php?controller=order']")));
//        element.click();
//    }
//
